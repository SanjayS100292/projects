<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="adminbakeryreg.aspx.cs" Inherits="bakeryman.WebForm10" %>
    ...
    <h1 style="background-color:#fd6d6d; text-align: center;">
     ...
     <table class="auto-style2" style="height: 617px">
         ...
         <tr>
             ...
             <td style="width: 306px; height: 16px;">
                 <asp:TextBox ID="TextBox3" runat="server" Height="75px" Width="149px" TextMode="MultiLine"></asp:TextBox>
             </td>
         </tr>
         <tr>
             <td class="auto-style6" style="width: 610px; height: 16px;"></td>
