<%@ Page Title="" Language="C#" MasterPageFile="~/shop.Master" AutoEventWireup="true" CodeBehind="shopprevorder.aspx.cs" Inherits="bakeryman.WebForm33" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bakeryConnectionString %>" SelectCommand="SELECT odrid, odrdate, deldate, quantity, price, paytype,id,shopuser FROM odr WHERE (shopuser = ?)" OnSelecting="SqlDataSource1_Selecting" ProviderName="<%$ ConnectionStrings:bakeryConnectionString.ProviderName %>" >
        <SelectParameters>
