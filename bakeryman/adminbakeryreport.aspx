<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="WebForm34.aspx.cs" Inherits="bakeryman.WebForm34" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="text-align: center">


        <br />
        <span style="text-decoration: underline; font-size: x-large"><strong>BAKERY ORDER DETAILS</strong></span><br />
        <br />
        FROM&nbsp;&nbsp;
